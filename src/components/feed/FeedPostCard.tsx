...
const styles = StyleSheet.create({
  card: { backgroundColor: colors.paper, borderRadius: borderRadius.md, borderWidth: 1, borderColor: colors.divider, padding: spacing.md, marginBottom: spacing.md, gap: spacing.sm },
  cardHighlighted: { borderWidth: 1.5, borderColor: colors.ink },
  header: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.inkBg, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 13, fontWeight: '600', fontFamily: fonts.semibold, color: colors.ink },
  ...
  draftBadge: { fontSize: 12, fontWeight: '600', fontFamily: fonts.semibold, color: colors.warnText, backgroundColor: colors.warnBg, borderRadius: borderRadius.xs, paddingHorizontal: 6, paddingVertical: 2 },
  section: { gap: spacing.xs },
  competency: { fontSize: 13, fontFamily: fonts.medium, color: colors.inkSoft },
  ...
  docName: { flex: 1, fontSize: 13, color: colors.ink, fontWeight: '500', fontFamily: fonts.medium },
  ...
  optionMine: { borderColor: colors.ink },
  optionFill: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: colors.inkBg },
