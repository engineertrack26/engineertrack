...
const styles = StyleSheet.create({
  ...
  bubbleMine: { backgroundColor: colors.ink, borderBottomRightRadius: 2 },
  bubbleOther: { backgroundColor: colors.paper, borderBottomLeftRadius: 2, borderWidth: 1, borderColor: colors.divider },
  ...
  time: { fontSize: 11, fontFamily: fonts.regular, color: colors.textSecondary, marginTop: 2, alignSelf: 'flex-end', fontVariant: ['tabular-nums'] },
