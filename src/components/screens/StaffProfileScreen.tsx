...
const ROLE_BADGE = {
  ...
  advisor: { label: 'Advisor', color: colors.info },
} as const;
...
/** The mentor's and the advisor's profile. The two route files were 777
 *  identical lines apart from the badge's label and colour; both now render
 *  this. The student's profile is a different screen with different
 *  sections (internship, linking codes, group) and stays separate. */
export function StaffProfileScreen({ role }: StaffProfileScreenProps) {
