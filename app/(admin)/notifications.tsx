...
export default function AdminNotificationsScreen() {
  ...
  const renderEmpty = () => {
    if (isLoading) return <ActivityIndicator size="large" color={ADMIN_COLOR} style={{ marginTop: 60 }} />;
    return (
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      {unreadCount > 0 && (
        <View style={styles.unreadBanner}>
          <Ionicons name="mail-unread-outline" size={18} color={ADMIN_COLOR} />
...
const styles = StyleSheet.create({
  ...
  notifUnread: {
    backgroundColor: ADMIN_COLOR + '08',
    borderLeftWidth: 3,
