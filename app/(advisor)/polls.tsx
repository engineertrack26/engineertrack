...
export default function AdvisorPollsScreen() {
  ...
  const handleClosePoll = (poll: Poll) => {
    Alert.alert('Close Poll', 'Are you sure? Users will no longer be able to respond.', [
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          >
            ...
            <View style={styles.typeRow}>
              {(['student', 'mentor', 'all'] as const).map((role) => (
                <TouchableOpacity
                  key={role}
                ...
                >
                  <Text style={[styles.typeChipText, targetRole === role && styles.typeChipTextActive]}>
                    {role === 'student' ? 'Students' : role === 'mentor' ? 'Mentors' : 'Everyone'}
                  </Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            {questions.length === 0 && (
              <View style={styles.noQuestionsCard}>
                ...
                <Text style={styles.noQuestionsText}>Add questions to your poll</Text>
              </View>
            )}
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>
                Create your first poll or survey for students.
              </Text>
            </View>
          }
        />
...
const styles = StyleSheet.create({
  ...
  modeHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, borderBottomWidth: 1, borderBottomColor: colors.divider },
  modeHeaderTitle: { fontSize: 17, fontWeight: '600', color: colors.text, flex: 1, textAlign: 'center', marginHorizontal: spacing.sm },
  fabBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.primary, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: borderRadius.full },
  fabText: { fontSize: 14, fontWeight: '600', color: '#fff' },
  listContent: { paddingHorizontal: spacing.lg, paddingBottom: spacing.xl },
  emptyList: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: spacing.lg },
  pollCard: { backgroundColor: colors.surface, borderRadius: borderRadius.md, marginBottom: spacing.sm, elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2 },
  pollCardMain: { flexDirection: 'row', alignItems: 'center', padding: spacing.md },
  pollCardInfo: { flex: 1 },
  pollCardTitle: { fontSize: 15, fontWeight: '600', color: colors.text },
  pollCardMeta: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginTop: spacing.xs },
  ...
  closeBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderTopWidth: 1, borderTopColor: colors.divider },
  closeBtnText: { fontSize: 13, color: colors.error, fontWeight: '500' },
  createContent: { paddingHorizontal: spacing.lg, paddingTop: spacing.md },
  inputLabel: { fontSize: 13, fontWeight: '600', color: colors.textSecondary, marginBottom: spacing.xs, marginTop: spacing.sm },
  input: { backgroundColor: colors.surface, borderRadius: borderRadius.sm, padding: spacing.sm, fontSize: 14, color: colors.text, borderWidth: 1, borderColor: colors.border },
  textArea: { minHeight: 60 },
  typeRow: { flexDirection: 'row', gap: spacing.sm, flexWrap: 'wrap' },
  typeChip: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: borderRadius.full, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.primary, paddingHorizontal: spacing.sm, paddingVertical: 6, borderRadius: borderRadius.sm },
  addBtnText: { fontSize: 13, fontWeight: '600', color: '#fff' },
  questionDraftCard: { backgroundColor: colors.surface, borderRadius: borderRadius.md, padding: spacing.md, marginTop: spacing.sm, borderWidth: 1, borderColor: colors.border },
  qdHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm },
  qdNumber: { fontSize: 13, fontWeight: '700', color: colors.primary },
  qTypeRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: spacing.sm },
  qTypeChip: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: borderRadius.sm, backgroundColor: colors.background, borderWidth: 1, borderColor: colors.border },
  qTypeChipActive: { backgroundColor: colors.info + '15', borderColor: colors.info },
  qTypeText: { fontSize: 11, color: colors.textSecondary, fontWeight: '500' },
  qTypeTextActive: { color: colors.info, fontWeight: '600' },
  optionsDraft: { marginTop: spacing.sm, gap: spacing.xs },
  optionDraftRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  optionInput: { flex: 1, backgroundColor: colors.background, borderRadius: borderRadius.sm, padding: spacing.sm, fontSize: 13, color: colors.text, borderWidth: 1, borderColor: colors.border },
  addOptionBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: spacing.xs },
  addOptionText: { fontSize: 13, color: colors.primary, fontWeight: '500' },
  correctHint: { fontSize: 11, color: colors.success, fontStyle: 'italic', marginTop: spacing.xs },
  noQuestionsCard: { alignItems: 'center', paddingVertical: spacing.xl, backgroundColor: colors.surface, borderRadius: borderRadius.md, marginTop: spacing.sm },
  noQuestionsText: { fontSize: 14, color: colors.textSecondary, marginTop: spacing.sm },
  createBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, backgroundColor: colors.success, borderRadius: borderRadius.md, paddingVertical: spacing.md, marginTop: spacing.lg },
  createBtnText: { fontSize: 16, fontWeight: '700', color: '#fff' },
  resultsContent: { paddingHorizontal: spacing.lg, paddingTop: spacing.md },
  resultsSummary: { backgroundColor: colors.surface, borderRadius: borderRadius.md, padding: spacing.md, marginBottom: spacing.md, elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2 },
  resultsPollTitle: { fontSize: 18, fontWeight: '700', color: colors.text, marginBottom: spacing.sm },
  resultsStats: { flexDirection: 'row', gap: spacing.xl },
  resultsStat: { alignItems: 'center' },
  resultsStatValue: { fontSize: 28, fontWeight: '700', color: colors.primary },
  resultsStatLabel: { fontSize: 12, color: colors.textSecondary, marginTop: 2 },
  questionResultCard: { backgroundColor: colors.surface, borderRadius: borderRadius.md, padding: spacing.md, marginBottom: spacing.sm },
  qrNumber: { fontSize: 11, fontWeight: '700', color: colors.primary, marginBottom: 4 },
  qrText: { fontSize: 14, fontWeight: '600', color: colors.text, marginBottom: spacing.sm },
  qrOptions: { gap: spacing.xs },
  qrOptionRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  qrBarBg: { flex: 1, height: 20, backgroundColor: colors.background, borderRadius: borderRadius.sm, overflow: 'hidden' },
  qrBarFill: { height: '100%', backgroundColor: colors.primary + '40', borderRadius: borderRadius.sm },
  qrOptionCount: { fontSize: 12, fontWeight: '600', color: colors.textSecondary, minWidth: 60 },
  qrRating: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  qrRatingText: { fontSize: 16, fontWeight: '600', color: colors.text },
  qrTextAnswers: { gap: spacing.xs },
  qrTextAnswer: { fontSize: 13, color: colors.textSecondary, fontStyle: 'italic', lineHeight: 18 },
  qrMoreText: { fontSize: 12, color: colors.textDisabled, marginTop: 4 },
